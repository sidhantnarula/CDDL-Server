...
(function () {
	...
	*/
	...
	var uncurryThis$i = NATIVE_BIND$3 && bind$8.bind(call$g, call$g);
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$5(val = call$e(fn, input))) return val;
	  if (isCallable$g(fn = input.valueOf) && !isObject$5(val = call$e(fn, input))) return val;
	  if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$5(val = call$e(fn, input))) return val;
	...
	if (!TO_STRING_TAG_SUPPORT) {
	  defineBuiltIn$8(Object.prototype, 'toString', toString$3, { unsafe: true });
	}
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$6 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$7(O, P)) return createPropertyDescriptor$3(!call$c(propertyIsEnumerableModule$1.f, O, P), O[P]);
	};
	...
	*/
	...
	var arraySlice$3 = uncurryThis$5([].slice);
	...
	var MessageChannel$1 = global$a.MessageChannel;
	...
	var ITERATOR$6 = wellKnownSymbol$7('iterator');

	var getIteratorMethod$4 = function (it) {
	  if (it != undefined) return getMethod$1(it, ITERATOR$6)
	...
	var getIterator$3 = function (argument, usingIterator) {
	  ...
	  if (aCallable$2(iteratorMethod)) return anObject$7(call$9(iteratorMethod, argument));
	    ...
	    value: function handleSubmit(event) {
	      ...
	      var fetchFile = /*#__PURE__*/function () {
	        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
	          var res, fileBlob, fileObjectURL;
	          return _regeneratorRuntime().wrap(function _callee$(_context) {
	            while (1) {
	              switch (_context.prev = _context.next) {
	                case 0:
	                  _context.next = 2;
	                  return fetch("http://localhost:3100/lise/" + _this2.state.value);
	...
	var App = /*#__PURE__*/function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _defineProperty(_assertThisInitialized(_this), "receiveChange", function (childData) {
	      _this.setState({
	        value: childData
	      });
	    });
	  ...
	  _createClass(App, [{
	    key: "render",
	    value: function render() {
	      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h1", null, "UGA CDDL LISE")), /*#__PURE__*/React.createElement(Input, {
	        communicateChange: this.receiveChange
